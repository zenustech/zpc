...
#define DEFINE_MAT_WITH_ROWS(rows, type, tail) \
    ...
    DEFINE_MAT(rows, 2, type, tail)            \
    DEFINE_MAT(rows, 3, type, tail)            \
    DEFINE_MAT(rows, 4, type, tail)            
...
#define LIST_MAT_VEC_TYPE(tail)                                                                               \
    mat11##tail, mat12##tail, mat13##tail, mat14##tail,                                                       \
    mat21##tail, mat22##tail, mat23##tail, mat24##tail,                                                       \
    mat31##tail, mat32##tail, mat33##tail, mat34##tail,                                                       \
    mat41##tail, mat42##tail, mat43##tail, mat44##tail,                                                       \
...
using SmallVec =
    variant<LIST_MAT_VEC_TYPE(i), LIST_MAT_VEC_TYPE(f), LIST_MAT_VEC_TYPE(d), int, float, double>;
} // namespace zs