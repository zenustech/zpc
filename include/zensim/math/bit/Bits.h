...
namespace zs {
  ...
  constexpr u32 morton_3d_32(float x, float y, float z) noexcept {
		return (expand_bits_32((u32)(x * 1024.f)) << 2) | (expand_bits_32((u32)(y * 1024.f)) << 1) | expand_bits_32((u32)(z * 1024.f));
	}
  constexpr u64 morton_3d_64(double x, double y, double z) {
		return (expand_bits_64((u32)(x * 2097152.)) << 2) | (expand_bits_64((u32)(y * 2097152.)) << 1) | expand_bits_64((u32)(z * 2097152.));
	}
  /**
   */
