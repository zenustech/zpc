...
#define INSTANTIATE_SPMAT_CAPIS(T, RowMajor, Ti, Tn)                                               \
  void build_from_triplets##__##omp##_##spm##_##T##_##RowMajor##_##Ti##_##Tn(                      \
  ...
  void build_from_doublets##__##omp##_##spm##_##T##_##RowMajor##_##Ti##_##Tn(                      \
      zs::OmpExecutionPolicy *ppol,                                                                \
      zs::SparseMatrix<T, RowMajor, Ti, Tn, zs::ZSPmrAllocator<false>> *spmat, Ti nrows, Ti ncols, \
      Ti *is, Ti *js, Tn nnz) {                                                                    \
    spmat->build(*ppol, nrows, ncols, zs::range(is, is + nnz), zs::range(js, js + nnz),            \
  ...
  void build_from_doublets_sym##__##omp##_##spm##_##T##_##RowMajor##_##Ti##_##Tn(                  \
      zs::OmpExecutionPolicy *ppol,                                                                \
      zs::SparseMatrix<T, RowMajor, Ti, Tn, zs::ZSPmrAllocator<false>> *spmat, Ti nrows, Ti ncols, \
      Ti *is, Ti *js, Tn nnz) {                                                                    \
    spmat->build(*ppol, nrows, ncols, zs::range(is, is + nnz), zs::range(js, js + nnz),            \
  ...
  void fast_build_from_doublets##__##omp##_##spm##_##T##_##RowMajor##_##Ti##_##Tn(                 \
      zs::OmpExecutionPolicy *ppol,                                                                \
      zs::SparseMatrix<T, RowMajor, Ti, Tn, zs::ZSPmrAllocator<false>> *spmat, Ti nrows, Ti ncols, \
      Ti *is, Ti *js, Tn nnz) {                                                                    \
  ...
  void fast_build_from_doublets_sym##__##omp##_##spm##_##T##_##RowMajor##_##Ti##_##Tn(             \
      zs::OmpExecutionPolicy *ppol,                                                                \
      zs::SparseMatrix<T, RowMajor, Ti, Tn, zs::ZSPmrAllocator<false>> *spmat, Ti nrows, Ti ncols, \
      Ti *is, Ti *js, Tn nnz) {                                                                    \
    spmat->fastBuild(*ppol, nrows, ncols, zs::range(is, is + nnz), zs::range(js, js + nnz),        \
  ...
  void transpose##__##omp##_##spm##_##T##_##RowMajor##_##Ti##_##Tn(                                \
      zs::OmpExecutionPolicy *ppol,                                                                \
