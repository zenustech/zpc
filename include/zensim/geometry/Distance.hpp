...
namespace zs {
  ...
  namespace detail {
    ...
    constexpr void pFpx_pppV0V1(T d, T x11, T x12, T x13, T x21, T x22, T x23, T x31, T x32, T x33,
                                T x41, T x42, T x43, VecInterface<VecT> &result) {
      // result: 12x9
      T t24{};
      T t25{};
      T t26{};
      ...
      t47 = t24 * t29 + -(t26 * t27);
      t48 = t25 * t29 + -(t26 * t28);
      t49 = 1 / zs::sqrt((t49 * t49 + t82 * t82) + t81 * t81);
      t67 = t8 * (x11 * 2 + -(x21 * 2)) * t49 / 2;
      t68 = t8 * (x12 * 2 + -(x22 * 2)) * t49 / 2;
      t69 = t8 * (x13 * 2 + -(x23 * 2)) * t49 / 2;
      t49 = 1 / zs::sqrt((t46 * t46 + t47 * t47) + t48 * t48);
      t78 = (t25 * t46 * 2 + t26 * t47 * 2) * t49 / 2;
      t8 = (t24 * t47 * 2 + t25 * t48 * 2) * t49 / 2;
      t25 = (t28 * t46 * 2 + t29 * t47 * 2) * t49 / 2;
      t81 = (t27 * t47 * 2 + t28 * t48 * 2) * t49 / 2;
      t82 = (t24 * t46 * 2 + -(t26 * t48 * 2)) * t49 / 2;
      t49 = (t27 * t46 * 2 + -(t29 * t48 * 2)) * t49 / 2;
      result[0][0] = 0;
      result[0][1] = 0;
      result[0][2] = 0;
      result[0][3] = 0;
    ...
    // pp
    template <typename T, typename VecT> constexpr void pFpx_pp2(T d, T x11, T x12, T x13, T x21,
                                                                 T x22, T x23,
                                                                 VecInterface<VecT> &result) {
      T t25{};
      T t26{};
      T t27{};
      T t8{};
      ...
      t26 = -x22 + x12;
      t27 = -x23 + x13;
      t25 = 1 / zs::sqrt((t25 * t25 + t26 * t26) + t27 * t27);
      t26 = t8 * (x11 * 2 + -(x21 * 2)) * t25 / 2;
      t27 = t8 * (x12 * 2 + -(x22 * 2)) * t25 / 2;
      t25 = t8 * (x13 * 2 + -(x23 * 2)) * t25 / 2;
      result[0] = t26;
      result[1] = t27;
      result[2] = t25;
      result[3] = -t26;
  ...
  constexpr auto pFpx_ppp(const VecInterface<VecT> &x0, const VecInterface<VecT> &x1,
  ...
  template <typename VecT, typename T>
  constexpr auto pFpx_pp2(const VecInterface<VecT> &x0, const VecInterface<VecT> &x1, T dHat) {
    using HessT =
        typename VecT::template variant_vec<typename VecT::value_type,
                                            integer_sequence<typename VecT::index_type, 6>>;
    HessT pFpx{};
    detail::pFpx_pp2(dHat, x0[0], x0[1], x0[2], x1[0], x1[1], x1[2], pFpx);
    return pFpx;
  }
  ...
  namespace detail {
    ...
    // pem
    template <typename T, typename VecT>
    constexpr void pFpx_ppeV0V1(T d, T x11, T x12, T x13, T x21, T x22, T x23, T x31, T x32, T x33,
                                T x41, T x42, T x43, VecInterface<VecT> &result) {
      // result: 12x9
      T t102{};
      T t103{};
      ...
      t94 = 1 / zs::sqrt((t63 * t63 + t64 * t64) + t65 * t65);
      t97 = (x21 * 2 + -(x31 * 2)) * t59 * t92;
      t98 = (x22 * 2 + -(x32 * 2)) * t59 * t92;
      t99 = (x23 * 2 + -(x33 * 2)) * t59 * t92;
      t96 = 1 / zs::sqrt(t58 * t92);
      t102 = (t29 * t63 * 2 + t31 * t64 * 2) * t94 / 2;
      t103 = (t30 * t63 * 2 + t32 * t64 * 2) * t94 / 2;
      t104 = (t27 * t64 * 2 + t29 * t65 * 2) * t94 / 2;
      t64 = (t28 * t64 * 2 + t30 * t65 * 2) * t94 / 2;
      t29 = (t27 * t63 * 2 + -(t31 * t65 * 2)) * t94 / 2;
      t59 = (t28 * t63 * 2 + -(t32 * t65 * 2)) * t94 / 2;
      result[0][0] = 0;
      result[0][1] = 0;
      result[0][2] = 0;
      result[0][3] = 0;
      ...
      result[0][7] = 0;
      t92 = t8 * t58 * t96;
      result[0][8] = t92 * (t30 * t60 * 2 + t32 * t61 * 2) / 2;
      result[1][0] = 0;
      result[1][1] = 0;
      result[1][2] = 0;
      result[1][3] = 0;
      ...
      result[1][6] = 0;
      result[1][7] = 0;
      result[1][8] = t92 * (t28 * t60 * 2 - t32 * t62 * 2) * -0.5;
      result[2][0] = 0;
      result[2][1] = 0;
      result[2][2] = 0;
      result[2][3] = 0;
      ...
      result[2][6] = 0;
      result[2][7] = 0;
      result[2][8] = t92 * (t28 * t61 * 2 + t30 * t62 * 2) * -0.5;
      result[3][0] = 0;
      result[3][1] = 0;
      result[3][2] = 0;
      result[3][3] = 0;
      ...
      result[3][7] = 0;
      t92 = t8 * t96;
      result[3][8] = t92 * (t97 + t58 * (t25 * t60 * 2 + t26 * t61 * 2)) * -0.5;
      result[4][0] = 0;
      result[4][1] = 0;
      result[4][2] = 0;
      result[4][3] = 0;
      ...
      result[4][6] = 0;
      result[4][7] = 0;
      result[4][8] = t92 * (t98 - t58 * (t24 * t60 * 2 - t26 * t62 * 2)) * -0.5;
      result[5][0] = 0;
      result[5][1] = 0;
      result[5][2] = 0;
      result[5][3] = 0;
      ...
      result[5][6] = 0;
      result[5][7] = 0;
      result[5][8] = t92 * (t99 - t58 * (t24 * t61 * 2 + t25 * t62 * 2)) * -0.5;
      result[6][0] = 0;
      result[6][1] = 0;
      result[6][2] = 0;
      result[6][3] = 0;
      ...
      result[6][6] = 0;
      result[6][7] = 0;
      result[6][8] = t92 * (t97 + t58 * (t22 * t60 * 2 + t23 * t61 * 2)) / 2;
      result[7][0] = 0;
      result[7][1] = 0;
      result[7][2] = 0;
      result[7][3] = 0;
      ...
      result[7][6] = 0;
      result[7][7] = 0;
      result[7][8] = t92 * (t98 - t58 * (t21 * t60 * 2 - t23 * t62 * 2)) / 2;
      result[8][0] = 0;
      result[8][1] = 0;
      result[8][2] = 0;
      result[8][3] = 0;
      ...
      result[8][6] = 0;
      result[8][7] = 0;
      result[8][8] = t92 * (t99 - t58 * (t21 * t61 * 2 + t22 * t62 * 2)) / 2;
      result[9][0] = 0;
      result[9][1] = 0;
      result[9][2] = 0;
      result[9][3] = 0;
    ...
    // pe
    template <typename T, typename VecT> constexpr void pFpx_pe2(T d, T x11, T x12, T x13, T x21,
                                                                 T x22, T x23, T x31, T x32, T x33,
                                                                 VecInterface<VecT> &result) {
      // result: 9x4
      T t18{};
      T t19{};
      ...
      t25 = -x32 + x22;
      t26 = -x33 + x23;
      t43 = 1 / ((t24 * t24 + t25 * t25) + t26 * t26);
      t45 = t18 * t22 + -(t19 * t21);
      t46 = t18 * t23 + -(t20 * t21);
      t47 = t19 * t23 + -(t20 * t22);
      t44 = t43 * t43;
      t51 = (t45 * t45 + t46 * t46) + t47 * t47;
      t54 = (x21 * 2 + -(x31 * 2)) * t44 * t51;
      t55 = (x22 * 2 + -(x32 * 2)) * t44 * t51;
      t56 = (x23 * 2 + -(x33 * 2)) * t44 * t51;
      t44 = 1 / zs::sqrt(t43 * t51);
      result[0][0] = 0;
      result[0][1] = 0;
      result[0][2] = 0;
      t51 = t8 * t43 * t44;
      result[0][3] = t51 * (t25 * t45 * 2 + t26 * t46 * 2) / 2;
      result[1][0] = 0;
      result[1][1] = 0;
      result[1][2] = 0;
      result[1][3] = t51 * (t24 * t45 * 2 - t26 * t47 * 2) * (T)-0.5;
      result[2][0] = 0;
      result[2][1] = 0;
      result[2][2] = 0;
      result[2][3] = t51 * (t24 * t46 * 2 + t25 * t47 * 2) * (T)-0.5;
      result[3][0] = 0;
      result[3][1] = 0;
      result[3][2] = 0;
      t51 = t8 * t44;
      result[3][3] = t51 * (t54 + t43 * (t22 * t45 * 2 + t23 * t46 * 2)) * (T)-0.5;
      result[4][0] = 0;
      result[4][1] = 0;
      result[4][2] = 0;
      result[4][3] = t51 * (t55 - t43 * (t21 * t45 * 2 - t23 * t47 * 2)) * (T)-0.5;
      result[5][0] = 0;
      result[5][1] = 0;
      result[5][2] = 0;
      result[5][3] = t51 * (t56 - t43 * (t21 * t46 * 2 + t22 * t47 * 2)) * (T)-0.5;
      result[6][0] = 0;
      result[6][1] = 0;
      result[6][2] = 0;
      result[6][3] = t51 * (t54 + t43 * (t19 * t45 * 2 + t20 * t46 * 2)) / 2;
      result[7][0] = 0;
      result[7][1] = 0;
      result[7][2] = 0;
      result[7][3] = t51 * (t55 - t43 * (t18 * t45 * 2 - t20 * t47 * 2)) / 2;
      result[8][0] = 0;
      result[8][1] = 0;
      result[8][2] = 0;
      result[8][3] = t51 * (t56 - t43 * (t18 * t46 * 2 + t19 * t47 * 2)) / 2;
    }
  }  // namespace detail

  template <typename VecT, typename T>
  constexpr auto pFpx_ppe(const VecInterface<VecT> &x0, const VecInterface<VecT> &x1,
                          const VecInterface<VecT> &x2, const VecInterface<VecT> &x3, T dHat) {
    using HessT =
        typename VecT::template variant_vec<typename VecT::value_type,
                                            integer_sequence<typename VecT::index_type, 12, 9>>;
  ...
  template <typename VecT, typename T>
  constexpr auto pFpx_pe2(const VecInterface<VecT> &x0, const VecInterface<VecT> &x1,
                          const VecInterface<VecT> &x2, T dHat) {
    using HessT =
        typename VecT::template variant_vec<typename VecT::value_type,
                                            integer_sequence<typename VecT::index_type, 9, 4>>;
    HessT pFpx{};
    detail::pFpx_pe2(dHat, x0[0], x0[1], x0[2], x1[0], x1[1], x1[2], x2[0], x2[1], x2[2], pFpx);
    return pFpx;
  }

  template <typename VecTP, typename VecTE,
            enable_if_all<VecTP::dim == 1, is_same_v<typename VecTP::dims, typename VecTE::dims>>
            = 0>
  ...
  namespace detail {
    ...
    // eem
    template <typename T, typename VecT>
    constexpr void pFpx_peeV0V1(T d, T x11, T x12, T x13, T x21, T x22, T x23, T x31, T x32, T x33,
                                T x41, T x42, T x43, VecInterface<VecT> &result) {
      // result: 12x9
      T t12{};
      T t13{};
      ...
      t46 = t12 * t20 + -(t14 * t18);
      t47 = t13 * t20 + -(t14 * t19);
      t69 = t13 * t45 * 2 + t14 * t46 * 2;
      t70 = t12 * t46 * 2 + t13 * t47 * 2;
      t71 = t19 * t45 * 2 + t20 * t46 * 2;
      t72 = t18 * t46 * 2 + t19 * t47 * 2;
      t19 = (t45 * t45 + t46 * t46) + t47 * t47;
      t73 = t12 * t45 * 2 + -(t14 * t47 * 2);
      t74 = t18 * t45 * 2 + -(t20 * t47 * 2);
      t76 = (T)1 / t19;
      t19 = (T)1 / zs::sqrt(t19);
      ...
      result[0][7] = 0;
      t70 = t76 * t79;
      t69 = (T)1 / d * (1 / zs::sqrt(t76 * t80));
      result[0][8] = t69 * (t20 - t70 * ((-t37 + t38) + t47) * 2) * -0.5;
      result[1][0] = 0;
      result[1][1] = 0;
      result[1][2] = 0;
      result[1][3] = 0;
      ...
      result[1][6] = 0;
      result[1][7] = 0;
      result[1][8] = t69 * (t19 - t70 * ((-t35 + t36) + t46) * 2) / 2;
      result[2][0] = 0;
      result[2][1] = 0;
      result[2][2] = 0;
      result[2][3] = 0;
      ...
      result[2][6] = 0;
      result[2][7] = 0;
      result[2][8] = t69 * (t18 + t70 * ((-t33 + t34) + t45) * 2) / 2;
      result[3][0] = 0;
      result[3][1] = 0;
      result[3][2] = 0;
      result[3][3] = 0;
      ...
      result[3][6] = 0;
      result[3][7] = 0;
      result[3][8] = t69 * (t20 + t70 * (t37 - t38) * 2) / 2;
      result[4][0] = 0;
      result[4][1] = 0;
      result[4][2] = 0;
      result[4][3] = 0;
      ...
      result[4][6] = 0;
      result[4][7] = 0;
      result[4][8] = t69 * (t19 + t70 * (t35 - t36) * 2) * -0.5;
      result[5][0] = 0;
      result[5][1] = 0;
      result[5][2] = 0;
      result[5][3] = 0;
      ...
      result[5][6] = 0;
      result[5][7] = 0;
      result[5][8] = t69 * (t18 - t70 * (t33 - t34) * 2) * -0.5;
      result[6][0] = 0;
      result[6][1] = 0;
      result[6][2] = 0;
      result[6][3] = 0;
      ...
      result[6][7] = 0;
      t20 = t13 * t17 + -(t14 * t16);
      result[6][8] = t69 * (t89 - t70 * (t20 + t47) * 2) / 2;
      result[7][0] = 0;
      result[7][1] = 0;
      result[7][2] = 0;
      result[7][3] = 0;
      ...
      result[7][7] = 0;
      t18 = t12 * t17 + -(t14 * t15);
      result[7][8] = t69 * (t71 - t70 * (t18 + t46) * 2) * -0.5;
      result[8][0] = 0;
      result[8][1] = 0;
      result[8][2] = 0;
      result[8][3] = 0;
      ...
      result[8][7] = 0;
      t19 = t12 * t16 + -(t13 * t15);
      result[8][8] = t69 * (t90 + t70 * (t19 + t45) * 2) * -0.5;
      result[9][0] = 0;
      result[9][1] = 0;
      result[9][2] = 0;
      result[9][3] = 0;
      ...
      result[9][6] = 0;
      result[9][7] = 0;
      result[9][8] = t69 * (t89 - t70 * t20 * 2) * -0.5;
      result[10][0] = 0;
      result[10][1] = 0;
      result[10][2] = 0;
      result[10][3] = 0;
      ...
      result[10][6] = 0;
      result[10][7] = 0;
      result[10][8] = t69 * (t71 - t70 * t18 * 2) / 2;
      result[11][0] = 0;
      result[11][1] = 0;
      result[11][2] = 0;
      result[11][3] = 0;
      ...
      result[11][6] = 0;
      result[11][7] = 0;
      result[11][8] = t69 * (t90 + t70 * t19 * 2) / 2;
    }
    // ee
    template <typename T, typename VecT>
    constexpr void pFpx_ee2(T d, T x11, T x12, T x13, T x21, T x22, T x23, T x31, T x32, T x33,
                            T x41, T x42, T x43, VecInterface<VecT> &result) {
      T t12{};
      T t13{};
      T t14{};
      ...
      t46 = t12 * t20 + -(t14 * t18);
      t47 = t13 * t20 + -(t14 * t19);
      t76 = 1 / ((t45 * t45 + t46 * t46) + t47 * t47);
      t78 = (t17 * t45 + t15 * t47) + -(t16 * t46);
      t77 = t76 * t76;
      t79 = t78 * t78;
      t82 = (t13 * t45 * 2 + t14 * t46 * 2) * t77 * t79;
      t83 = (t12 * t46 * 2 + t13 * t47 * 2) * t77 * t79;
      t84 = (t19 * t45 * 2 + t20 * t46 * 2) * t77 * t79;
      t19 = (t18 * t46 * 2 + t19 * t47 * 2) * t77 * t79;
      t86 = (t12 * t45 * 2 + -(t14 * t47 * 2)) * t77 * t79;
      t20 = (t18 * t45 * 2 + -(t20 * t47 * 2)) * t77 * t79;
      t78 *= t76;
      t77 = 1 / d * ((T)1.0 / zs::sqrt(t76 * t79));
      result[0][0] = 0;
      result[0][1] = 0;
      result[0][2] = 0;
      result[0][3] = 0;
      ...
      result[0][6] = 0;
      result[0][7] = 0;
      result[0][8] = t77 * (t84 - t78 * ((-t37 + t38) + t47) * 2) * (T)-0.5;
      result[1][0] = 0;
      result[1][1] = 0;
      result[1][2] = 0;
      result[1][3] = 0;
      ...
      result[1][6] = 0;
      result[1][7] = 0;
      result[1][8] = t77 * (t20 - t78 * ((-t35 + t36) + t46) * 2) / 2;
      result[2][0] = 0;
      result[2][1] = 0;
      result[2][2] = 0;
      result[2][3] = 0;
      ...
      result[2][6] = 0;
      result[2][7] = 0;
      result[2][8] = t77 * (t19 + t78 * ((-t33 + t34) + t45) * 2) / 2;
      result[3][0] = 0;
      result[3][1] = 0;
      result[3][2] = 0;
      result[3][3] = 0;
      ...
      result[3][6] = 0;
      result[3][7] = 0;
      result[3][8] = t77 * (t84 + t78 * (t37 - t38) * 2) / 2.0;
      result[4][0] = 0;
      result[4][1] = 0;
      result[4][2] = 0;
      result[4][3] = 0;
      ...
      result[4][6] = 0;
      result[4][7] = 0;
      result[4][8] = t77 * (t20 + t78 * (t35 - t36) * 2.0) * (T)-0.5;
      result[5][0] = 0;
      result[5][1] = 0;
      result[5][2] = 0;
      result[5][3] = 0;
      ...
      result[5][6] = 0;
      result[5][7] = 0;
      result[5][8] = t77 * (t19 - t78 * (t33 - t34) * 2) * (T)-0.5;
      result[6][0] = 0;
      result[6][1] = 0;
      result[6][2] = 0;
      result[6][3] = 0;
      ...
      result[6][7] = 0;
      t18 = t13 * t17 + -(t14 * t16);
      result[6][8] = t77 * (t82 - t78 * (t18 + t47) * 2) / 2;
      result[7][0] = 0;
      result[7][1] = 0;
      result[7][2] = 0;
      result[7][3] = 0;
      ...
      result[7][7] = 0;
      t20 = t12 * t17 + -(t14 * t15);
      result[7][8] = t77 * (t86 - t78 * (t20 + t46) * 2) * (T)-0.5;
      result[8][0] = 0;
      result[8][1] = 0;
      result[8][2] = 0;
      result[8][3] = 0;
      ...
      result[8][7] = 0;
      t19 = t12 * t16 + -(t13 * t15);
      result[8][8] = t77 * (t83 + t78 * (t19 + t45) * 2) * (T)-0.5;
      result[9][0] = 0;
      result[9][1] = 0;
      result[9][2] = 0;
      result[9][3] = 0;
      ...
      result[9][6] = 0;
      result[9][7] = 0;
      result[9][8] = t77 * (t82 - t78 * t18 * 2) * (T)-0.5;
      result[10][0] = 0;
      result[10][1] = 0;
      result[10][2] = 0;
      result[10][3] = 0;
      ...
      result[10][6] = 0;
      result[10][7] = 0;
      result[10][8] = t77 * (t86 - t78 * t20 * 2) / 2;
      result[11][0] = 0;
      result[11][1] = 0;
      result[11][2] = 0;
      result[11][3] = 0;
      ...
      result[11][6] = 0;
      result[11][7] = 0;
      result[11][8] = t77 * (t83 + t78 * t19 * 2) / 2;
    }
  }  // namespace detail

  template <typename VecT, typename T>
  constexpr auto pFpx_pee(const VecInterface<VecT> &x0, const VecInterface<VecT> &x1,
                          const VecInterface<VecT> &x2, const VecInterface<VecT> &x3, T dHat) {
    using HessT =
        typename VecT::template variant_vec<typename VecT::value_type,
                                            integer_sequence<typename VecT::index_type, 12, 9>>;
  ...
  template <typename VecT, typename T>
  constexpr auto pFpx_ee2(const VecInterface<VecT> &x0, const VecInterface<VecT> &x1,
                          const VecInterface<VecT> &x2, const VecInterface<VecT> &x3, T dHat) {
    using HessT =
        typename VecT::template variant_vec<typename VecT::value_type,
                                            integer_sequence<typename VecT::index_type, 12, 9>>;
    HessT pFpx{};
    detail::pFpx_ee2(dHat, x0[0], x0[1], x0[2], x1[0], x1[1], x1[2], x2[0], x2[1], x2[2], x3[0],
                     x3[1], x3[2], pFpx);
    return pFpx;
  }
  ...
  namespace detail {
    ...
    // pt
    template <typename T, typename VecT>
    constexpr void pFpx_pt2(T d, T x11, T x12, T x13, T x21, T x22, T x23, T x31, T x32, T x33,
                            T x41, T x42, T x43, VecInterface<VecT> &result) {
      // result 12x9
      T b_d{};
      T t12{};
      ...
      t34 = t15 * t20 + -(t17 * t18);
      t35 = t16 * t20 + -(t17 * t19);
      t44 = 1 / ((t33 * t33 + t34 * t34) + t35 * t35);
      t46 = (t14 * t33 + t12 * t35) + -(t13 * t34);
      t47 = t46 * t46;
      t49 = 1 / zs::sqrt(t44 * t47);
      result[0][0] = 0;
      result[0][1] = 0;
      result[0][2] = 0;
      result[0][3] = 0;
      ...
      result[3][8]
          = t47
            * (b_d * (t22 * t33 * 2 + t23 * t34 * 2) + t44 * ((t35 + t13 * t23) - t14 * t22) * 2)
            * (T)-0.5;
      result[4][0] = 0;
      result[4][1] = 0;
      result[4][2] = 0;
      ...
      result[4][8]
          = t47
            * (b_d * (t21 * t33 * 2 - t23 * t35 * 2) + t44 * ((t34 + t12 * t23) - t14 * t21) * 2)
            / 2;
      result[5][0] = 0;
      result[5][1] = 0;
      result[5][2] = 0;
      ...
      result[5][8]
          = t47
            * (b_d * (t21 * t34 * 2 + t22 * t35 * 2) - t44 * ((t33 + t12 * t22) - t13 * t21) * 2)
            / 2;
      result[6][0] = 0;
      result[6][1] = 0;
      result[6][2] = 0;
      ...
      result[6][7] = 0;
      result[6][8]
          = t47 * (t44 * (t13 * t20 - t14 * t19) * 2 + b_d * (t19 * t33 * 2 + t20 * t34 * 2)) / 2;
      result[7][0] = 0;
      result[7][1] = 0;
      result[7][2] = 0;
      result[7][3] = 0;
      ...
      result[7][7] = 0;
      result[7][8] = t47
                     * (t44 * (t12 * t20 - t14 * t18) * 2 + b_d * (t18 * t33 * 2 - t20 * t35 * 2))
                     * (T)-0.5;
      result[8][0] = 0;
      result[8][1] = 0;
      result[8][2] = 0;
      ...
      result[8][7] = 0;
      result[8][8]
          = t47 * (t44 * (t12 * t19 - t13 * t18) * 2 - b_d * (t18 * t34 * 2 + t19 * t35 * 2)) / 2;
      result[9][0] = 0;
      result[9][1] = 0;
      result[9][2] = 0;
      result[9][3] = 0;
      ...
      result[9][7] = 0;
      result[9][8] = t47
                     * (t44 * (t13 * t17 - t14 * t16) * 2 + b_d * (t16 * t33 * 2 + t17 * t34 * 2))
                     * (T)-0.5;
      result[10][0] = 0;
      result[10][1] = 0;
      result[10][2] = 0;
      ...
      result[10][7] = 0;
      result[10][8]
          = t47 * (t44 * (t12 * t17 - t14 * t15) * 2 + b_d * (t15 * t33 * 2 - t17 * t35 * 2)) / 2;
      result[11][0] = 0;
      result[11][1] = 0;
      result[11][2] = 0;
      result[11][3] = 0;
      ...
      result[11][7] = 0;
      result[11][8] = t47
                      * (t44 * (t12 * t16 - t13 * t15) * 2 - b_d * (t15 * t34 * 2 + t16 * t35 * 2))
                      * (T)-0.5;
    }
  ...
  template <typename VecT, typename T>
  constexpr auto pFpx_pt2(const VecInterface<VecT> &x0, const VecInterface<VecT> &x1,
                          const VecInterface<VecT> &x2, const VecInterface<VecT> &x3, T dHat) {
    using HessT =
        typename VecT::template variant_vec<typename VecT::value_type,
                                            integer_sequence<typename VecT::index_type, 12, 9>>;
    HessT pFpx{};
    detail::pFpx_pt2(dHat, x0[0], x0[1], x0[2], x1[0], x1[1], x1[2], x2[0], x2[1], x2[2], x3[0],
                     x3[1], x3[2], pFpx);
    return pFpx;
  }
  ...
  template <typename VecTP, typename VecT,
            enable_if_all<VecTP::dim == 1, is_same_v<typename VecTP::dims, typename VecT::dims>>
            = 0>
  ...
  template <typename VecTE, typename VecT,
            enable_if_all<VecTE::dim == 1, is_same_v<typename VecTE::dims, typename VecT::dims>>
            = 0>
