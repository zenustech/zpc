...
PER_CUDA_FUNCTION(getDeviceAttribute, cuDeviceGetAttribute, int *, uint32_t,
                  void *);
...
PER_CUDA_FUNCTION(memcpyPeerAsync, cuMemcpyPeerAsync, void *, void *, void *,
...
// Memory management
PER_CUDA_FUNCTION(memcpy, cuMemcpy, void *, void *, std::size_t);
...
PER_CUDA_FUNCTION(memcpyAsync, cuMemcpyAsync, void *, void *, std::size_t,
                  void *);
PER_CUDA_FUNCTION(memcpyHtoDAsync, cuMemcpyHtoDAsync_v2, void *, void *,
                  std::size_t, void *);
PER_CUDA_FUNCTION(memcpyDtoHAsync, cuMemcpyDtoHAsync_v2, void *, void *,
                  std::size_t, void *);
PER_CUDA_FUNCTION(memcpyDtoDAsync, cuMemcpyDtoDAsync_v2, void *, void *,
                  std::size_t, void *);

PER_CUDA_FUNCTION(malloc, cuMemAlloc_v2, void **, std::size_t);
PER_CUDA_FUNCTION(vmalloc, cuMemAllocManaged, void *, std::size_t, uint32_t);
PER_CUDA_FUNCTION(memset, cuMemsetD8_v2, void *, uint8_t, std::size_t);
PER_CUDA_FUNCTION(memsetAsync, cuMemsetD8Async, void *, uint8_t, std::size_t,
                  void *);
PER_CUDA_FUNCTION(free, cuMemFree_v2, void *);
PER_CUDA_FUNCTION(memAdvise, cuMemAdvise, void *, std::size_t, uint32_t, int);
PER_CUDA_FUNCTION(memInfo, cuMemGetInfo_v2, std::size_t *, std::size_t *);

// Module and kernels
PER_CUDA_FUNCTION(getModuleFunc, cuModuleGetFunction, void **, void *,
                  const char *);
PER_CUDA_FUNCTION(getFuncAttrib, cuFuncGetAttribute, int *, uint32_t, void *);
PER_CUDA_FUNCTION(loadModuleDataEx, cuModuleLoadDataEx, void **, const char *,
                  uint32_t, uint32_t *, void **)
PER_CUDA_FUNCTION(launchKernel, cuLaunchKernel, void *, uint32_t, uint32_t,
                  uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, void *,
                  void **, void **);
PER_CUDA_FUNCTION(launchCooperativeKernel, cuLaunchCooperativeKernel, void *,
