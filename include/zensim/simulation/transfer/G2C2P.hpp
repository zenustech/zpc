...
namespace zs {
  ...
  template <transfer_scheme_e, typename ConstitutiveModel, typename GridsT, typename TableT,
            typename ParticlesT>
  ...
  G2C2PTransfer(wrapv<space>, wrapv<scheme>, float, Model, Grids<T, d, l>, TableT, ParticlesT)
      -> G2C2PTransfer<scheme, Model, GridsView<space, Grids<T, d, l>>,
  ...
  template <execspace_e space, transfer_scheme_e scheme, typename ModelT, typename GridsT,
            typename TableT, typename ParticlesT>
  struct G2C2PTransfer<scheme, ModelT, GridsView<space, GridsT>, HashTableView<space, TableT>,
    ...
    explicit G2C2PTransfer(wrapv<space>, wrapv<scheme>, float dt, const ModelT& model,
                           GridsT& grids, TableT& table, ParticlesT& particles)
        : model{model},
