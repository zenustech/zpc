...
namespace zs {
  ...
  P2C2GTransfer(wrapv<space>, wrapv<scheme>, float, Model, ParticlesT, TableT, Grids<T, d, l>)
      -> P2C2GTransfer<scheme, Model, ParticlesView<space, ParticlesT>,
                       HashTableView<space, TableT>, GridsView<space, Grids<T, d, l>>>;

  template <execspace_e space, transfer_scheme_e scheme, typename ModelT, typename ParticlesT,
            typename TableT, typename GridsT>
  struct P2C2GTransfer<scheme, ModelT, ParticlesView<space, ParticlesT>,
                       HashTableView<space, TableT>, GridsView<space, GridsT>> {
