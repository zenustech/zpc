...
#define INSTANTIATE_TILE_VECTOR_VIEWLITE(T, L)                                                 \
  ...
  zs::TileVectorNamedViewLite<T, L> *pyview##__##tv##_##named##_##named##_##T##_##L(           \
  ...
  zs::TileVectorNamedViewLite<const T, L> *pyview##__##tv##_##named##_##const##_##T##_##L(     \
  ...
  zs::TileVectorNamedViewLite<T, L> *pyview##__##tv##_##named##_##T##_##L##_##virtual(         \
      zs::true_type, zs::TileVector<T, L, zs::ZSPmrAllocator<true>> & v) {                     \
    return new zs::TileVectorNamedViewLite<T, L>{v.data(),          v.numChannels(),           \
                                                 v.tagNameHandle(), v.tagOffsetHandle(),       \
                                                 v.tagSizeHandle(), v.numProperties()};        \
  }                                                                                            \
  zs::TileVectorNamedViewLite<const T, L>                                                      \
      *pyview##__##tv##_##named##_##const##_##T##_##L##_##virtual(                             \
