...
namespace zs {
  ...
  MonotonicAllocator::MonotonicAllocator(std::size_t totalMemBytes, std::size_t textureAlignBytes)
      : stack_allocator{&raw_memory_resource<device_mem_tag>::instance(), totalMemBytes,
                        textureAlignBytes} {
  ...
  MonotonicVirtualAllocator::MonotonicVirtualAllocator(int devId, std::size_t totalMemBytes,
      ...
      : stack_allocator{&raw_memory_resource<um_mem_tag>::instance(), totalMemBytes, textureAlignBytes} {
